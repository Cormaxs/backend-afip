import { facturaEmitida } from "../../services/facturas_services.js";
...
export async function facEmitidasControllers(datos, ubicacionGuardado) {
   try {
    ...
    return console.log("Guardada -> ",guardada);
  } catch (err) {
...
function fillInvoiceData(services, guardada) {
  ...
  const finalJson = {
    ...
    puntoDeVenta: "666b1a2c3d4e5f6a7b8c9d0f", // ID interno del punto de venta
